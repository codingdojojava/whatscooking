        ...
        <c:forEach items="${favoritess}" var="favorite" varStatus="loop">
            $.ajax({
                ...
                success: function(res){
                        ...
                        $("#temptab").append("<img src='"+imgUrl+"'><h3>"+res.name+"</h3><form class='rmFav' method='POST' action='/home/favorites/${favorite.id}/delete'><input type='hidden' name='${_csrf.parameterName}' value='${_csrf.token}'/><input class='links' type='submit' value='Remove Favorite' /></form><p>"+res.cookTime+"</p>");
